...
__Add information on the knitr and DT librarys including why you choose them!___
...
**I'd recommend making the chart a little nicer by using the function that we created a few homeworks ago to calculate the min, 1st quartile etc.  the min, 1st q etc makes the chart look a little buisy**
